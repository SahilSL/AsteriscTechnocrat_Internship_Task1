...
class cafe_billing_application:
    ...
    def save_bill(self):
        ...
        if op>0:
            ...
            f1=open("C:\\Users\\sahil\\OneDrive\\Desktop\\ATSIP INTERNSHIP\\CAFE BILLING SYSTEM\\test\\bills/"+str(self.bill.get())+".txt","w")
    ...
    def find_bill(self):
        present="no"
        for i in os.listdir("C:\\Users\\sahil\\OneDrive\\Desktop\\ATSIP INTERNSHIP\\CAFE BILLING SYSTEM\\test\\bills/"):
            if i.split('.')[0]==self.search_bill.get():
                f1=open(f"C:\\Users\\sahil\\OneDrive\\Desktop\\ATSIP INTERNSHIP\\CAFE BILLING SYSTEM\\test\\bills/{i}","r")
                self.txtarea.delete('1.0',END)
                for d in f1:
